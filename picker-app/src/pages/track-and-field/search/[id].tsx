...
import { spikeLoader, spikesLoader } from 'api/loader/track-and-field/spikeLoader';
...
TAFSpikePage.getLayout = (page: ReactElement) => {
  return (
    <TAFLayout
      links={[TAF_INDEX_PAGE_LINK, { label: '検索結果一覧', href: TAF_SEARCH_PAGE_PATH }, { label: 'スパイク詳細' }]}
    >
      {page}
    </TAFLayout>
  );
